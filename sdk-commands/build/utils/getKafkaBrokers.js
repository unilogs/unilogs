...
function getKafkaBrokers(props) {
    return __awaiter(this, void 0, void 0, function* () {
        const kafkaClient = (0, createKafkaClient_1.default)({ region: props.region, credentials: props.credentials });
        const bootstrapBrokerInfo = yield kafkaClient.send(new client_kafka_1.GetBootstrapBrokersCommand({ ClusterArn: props.kafkaArn }));
