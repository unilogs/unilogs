...
class EKSTokenGenerator {
  ...
  constructor(credentials: AwsCredentialIdentity, clusterName: string, region: string) {
  ...
  generate(expires = '60') {
    ...
    if (!this.credentials.accessKeyId || !this.credentials.secretAccessKey || !this.region) {
