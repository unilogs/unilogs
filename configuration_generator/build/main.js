...
import { ApacheTransform, ClfTransform, LinuxAuthorizationTransform, LogfmtTransform, SyslogTransform, } from './lib/Transform.js';
...
// }
async function simpleAddSourceAndTransform(vectorConfiguration) {
...
async function addSinkBuildAndRun(vectorConfiguration) {
...
async function main() {
    ...
    while (notDone) {
        console.clear();
        console.log(gradient(['#75CFE8', '#2D2372']).multiline(logo));
